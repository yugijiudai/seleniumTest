...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='demo';
...
VALUES (1, '点击登录', '什么都不做直接点登录', 'CLICK', 'API', 'btn', 'ID', NULL, 'Y',
        '{\"className\":\"com.lml.selenium.demo.asserts.DemoAssert\",\"methodName\":\"assertTestDemo01\",\"args\":[\"用户不存在\"]}', NULL);
INSERT INTO `demo_test`
VALUES (2, '输入用户名haha', '输入错密码', 'SEND_KEYS', NULL, 'name', 'ID', 'haha', 'Y', NULL, NULL);
INSERT INTO `demo_test`
VALUES (3, '输入密码1', '输入错密码', 'SEND_KEYS', NULL, 'pass', 'ID', '1', 'Y', NULL, NULL);
INSERT INTO `demo_test`
VALUES (4, '点击登录', '输入错密码', 'CLICK', 'API', 'btn', 'ID', NULL, 'Y',
        '{\"className\":\"com.lml.selenium.demo.asserts.DemoAssert\",\"methodName\":\"assertTestDemo02\",\"args\":[\"密码错误\"]}', NULL);
INSERT INTO `demo_test`
VALUES (5, '输入用户名', '登录成功', 'SEND_KEYS', NULL, '#name', 'CSS_SELECTOR', 'lml', 'Y', NULL, NULL);
INSERT INTO `demo_test`
VALUES (6, '输入密码', '登录成功', 'SEND_KEYS', NULL, '//input[@id=\'pass\']', 'XPATH', '111111', 'Y', NULL, NULL);
INSERT INTO `demo_test`
VALUES (7, '点击登录', '登录成功', 'CLICK', 'API', 'btn', 'ID', NULL, 'Y', '{\"className\":\"com.lml.selenium.demo.asserts.DemoAssert\",\"methodName\":\"assertTestDemo03\"}', NULL);
INSERT INTO `demo_test`
VALUES (8, '输入alert脚本', '登录成功', 'RUN_SCRIPT', NULL, NULL, NULL, '{\'script\': \'alert(111)\'}', 'Y', NULL, 2000);
INSERT INTO `demo_test`
VALUES (9, '点击alert', '登录成功', 'ALERT', NULL, NULL, NULL, NULL, 'Y', NULL, NULL);
INSERT INTO `demo_test`
VALUES (10, '切换到iframe', 'iframeSelf', 'SWITCH_MY_FRAME', NULL, '', NULL, '{\"type\": \"self\", \"url\": \"http://127.0.0.1:8080/iframe.html\"}', 'Y', NULL, NULL);
INSERT INTO `demo_test`
VALUES (12, '双击iframe里的按钮', 'iframeSelf', 'CLICK', 'DOUBLE_CLICK', 'dbClick', 'ID', NULL, 'Y', NULL, NULL);
INSERT INTO `demo_test`
VALUES (13, '运行js脚本把dom带回去', 'iframeSelf', 'RUN_SCRIPT', NULL, NULL, NULL,
        ...
        'Y', NULL, NULL);
INSERT INTO `demo_test`
VALUES (14, '打开新窗口', '新窗口', 'CLICK', 'API', 'newWindow', 'ID', NULL, 'Y', NULL, NULL);
INSERT INTO `demo_test`
VALUES (15, '切换到新窗口', '新窗口', 'SWITCH_WINDOW', NULL, NULL, NULL, '1', 'Y', NULL, NULL);
INSERT INTO `demo_test`
VALUES (16, '获取所有输入框输入内容', '新窗口', 'SEND_KEYS', NULL, 'ipt', 'CLASS_NAME', 'hello', 'Y',
        '{\"className\": \"com.lml.selenium.demo.asserts.DemoAssert\", \"methodName\": \"assertWindowAndCallBack\", \"args\": [\"hello\"]}', NULL);
COMMIT;
